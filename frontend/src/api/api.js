...
const API = axios.create({
  baseURL: 'https://attendance-management-system-z22k.onrender.com/api'
});
...
export const getByStudent = (id) =>
  API.get(`/attendance/student/${id}`);

export const getMonthly = (month, year) =>
...
export const exportCSV = (start, end) =>
  API.get(`/attendance/export?start=${start}&end=${end}`, {
    responseType: 'blob'
  });
